  ...
  return (
    <div className=''>
      ...
      className='w-full p-24 H1Item  '><div
       className='Main5H1 text-white w-7/12 font-bold text-[53px] text-left'>Small group travel that's <br />  good all over
      </div>
 </div>
...
<div  data-Aos="zoom-in"
          data-Aos-duration="1500"  className='Main5Info bg-white w-[450px] rounded-3xl flex  justify-center gap-6  p-11 flex-col '>
